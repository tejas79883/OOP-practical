...
System.out.println("Withdrawal failed. Maximum limit of withdrawal in one 
transaction is Rs.20000."); 
} 
...
System.out.println("Balance is: "+a.getBalance());//calling getbalance 
method 
} 
...
System.out.println("Account Id: "+a.getAccountId()); //display Account Id of 
customer
System.out.println("Account Type: "+a.getAccountType()); //display Account Type of 
customer
...
break; 
case 2:
bm.displayAccountInformation(); //calling 
displayAccountInformation method
System.out.println("=================================================");
break; 
case 3:
...
break; 
case 5:
bm.getWithdrawAmount(); //calling getWithdrawAmount 
method 
System.out.println("=================================================");
break;
case 6:
